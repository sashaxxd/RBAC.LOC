...
<!--                            <li><a href="--><?//= \yii\helpers\Url::to('/cabinet')?><!--">Личный кабинет</a></li>-->
                ...
                <div class="col-3">
                    <?php if(Yii::$app->user->isGuest): ?>
                        ...
                        <div id="wb_Text2">
                            <a href="<?= \yii\helpers\Url::to(['auth/signup'])?>"><span id="wb_uid1"><strong>РЕГИСТРАЦИЯ</strong></span></a>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-4">
                    <?php if(!Yii::$app->user->isGuest): ?>
                        ...
                        <div id="wb_Text7">
                            <a href="<?= \yii\helpers\Url::to(['/auth/logout'])?>"><span id="wb_uid2">&nbsp; Выход</span></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
