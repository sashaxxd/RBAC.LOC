...
use Yii;
use app\modules\admin\models\Freelancers;
use app\modules\admin\models\FreelancersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * FreelancersController implements the CRUD actions for Freelancers model.
 */
class FreelancersController extends Controller
{
     ...
     * @param integer $id
     * @return Freelancers the loaded model
