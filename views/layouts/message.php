                ...
                <div class="col-4">
                    <?php if(!Yii::$app->user->isGuest): ?>
                        <div id="wb_FontAwesomeIcon1">
                            <div id="FontAwesomeIcon1"><i class="fa fa-expeditedssl">&nbsp;</i></div>
                        </div>

                        <div id="wb_Text7">
                            <a href="<?= \yii\helpers\Url::to(['auth/logout'])?>"><span id="wb_uid2">&nbsp; Выход <?= Yii::$app->user->identity->username?></span></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
